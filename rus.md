...
В SASS есть возможность использовать *плейсхолдеры*, которые делают тоже самое.
...
наследоваться от другого миксины. Это невозможно сделать в LESS, потому что там
...
селекоторов, всплытия медиавыражений, импорта файлов, переменных, миксинов.
